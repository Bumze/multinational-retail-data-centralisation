...
class DataCleaning:
    ...
    def clean_store_data(self, stores_df):
        ...
        drops duplicate 'index' and 'lat' colunms and reset index. It returns stores_df dataframe.'''
    ...
    def clean_card_data(self, card_df):
        '''A method created to clean card data. It takes card_df as a parameter, enforces card column vslues are digits
        and changes dates dtype to datetime. Duplicate columns dropped and index reset. It returns card_df dataframe.'''
    ...
    def clean_products_data(self, products_df):
        ...
        products_df.drop(products_df.columns[cols], axis=1)
    ...
    def clean_orders_data(self, orders_df):
        ...
        orders_df= orders_df.drop(orders_df.columns[:2], axis = 1)
